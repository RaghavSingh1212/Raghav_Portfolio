...
const Home = () => {
  return (
    <div className="relative">
      {/* Home Section */}
      <section className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 relative overflow-hidden pt-32">
        {/* Animated Background */}
        ...
        <div className="container mx-auto relative z-10 px-4">
          <div className="flex flex-col xl:flex-row items-center gap-x-8 h-full pt-20 sm:pt-32 xl:pt-40 pb-10">
            {/* text */}
            <div className="flex-1 text-center xl:text-left">
              ...
              >
                <h1 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold mb-4 sm:mb-6 text-gray-100 leading-tight">
                  Hello I&apos;m <br /> <span className="text-gradient-cyan">Raghav Singh</span>
                </h1>
                <p className="max-w-[500px] mb-6 sm:mb-9 text-gray-300 text-base sm:text-lg md:text-xl px-4 sm:px-0 mx-auto xl:mx-0">
                ...
                <div className="flex flex-col xl:flex-row items-center gap-4 sm:gap-8">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full justify-center xl:justify-start px-4 sm:px-0">
                                          <a
                        href="https://drive.google.com/file/d/1cdRXLp1XDS4nc10LuZmJW5u238w-apzu/view?usp=sharing"
                        target="_blank"
                      ...
                      >
                        <svg className="text-lg sm:text-2xl group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24" width="1em" height="1em"><path d="M12 16V4m0 12l-4-4m4 4l4-4M4 20h16" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>
                        Resume
                      </a>
                      <a
                      ...
                      >
                        <svg className="text-lg sm:text-2xl group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24" width="1em" height="1em"><path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.28c-.97 0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 1.75-.78 1.75-1.75 1.75zm15.5 11.28h-3v-5.6c0-1.34-.03-3.07-1.87-3.07-1.87 0-2.16 1.46-2.16 2.97v5.7h-3v-10h2.88v1.36h.04c.4-.75 1.38-1.54 2.84-1.54 3.04 0 3.6 2 3.6 4.59v5.59z"/></svg>
                        LinkedIn
                      </a>
                      <a
            ...
            {/* image */}
            <div className="flex-1 relative mt-8 xl:mt-0">
              <motion.div
