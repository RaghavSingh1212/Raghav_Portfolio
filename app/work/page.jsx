...
const Work = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 relative overflow-hidden pt-32 pb-20">
      {/* Animated Background */}
